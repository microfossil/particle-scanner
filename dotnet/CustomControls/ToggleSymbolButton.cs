...
namespace CustomControls
{
    ...
    ///
    /// </summary>
    public class ToggleSymbolButton : ToggleButton
    {
        static ToggleSymbolButton()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ToggleSymbolButton), new FrameworkPropertyMetadata(typeof(ToggleSymbolButton)));
        }
