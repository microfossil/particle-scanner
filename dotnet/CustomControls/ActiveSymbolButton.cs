...
namespace CustomControls
{
    ...
    ///
    /// </summary>
    public class ActiveSymbolButton : SymbolButton
    {
        static ActiveSymbolButton()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ActiveSymbolButton), new FrameworkPropertyMetadata(typeof(ActiveSymbolButton)));
        }
        ...
        {
            get { return (String)GetValue(InactiveSymbolProperty); }
            set { SetValue(InactiveSymbolProperty, value); }
        }
        ...
        public static readonly DependencyProperty InactiveTextProperty =
            DependencyProperty.Register("InactiveText",
                typeof(string),
                typeof(ActiveSymbolButton),
                new PropertyMetadata(""));

        public static readonly DependencyProperty InactiveSymbolProperty =
            DependencyProperty.Register("InactiveSymbol",
                typeof(string),
                typeof(ActiveSymbolButton),
                new PropertyMetadata(""));
